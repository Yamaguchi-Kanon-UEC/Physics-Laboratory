...
減衰振動と過減衰のそれぞれの減衰の度合いについて，理論と実験を比較する．理論値と実験値，その相対誤差を表\ref{Ddeg}に示す．
...
\begin{table}[htbp]
    \begin{center}
        ...
        \begin{tabular}{c|rrr}
            \hline
            現象 & \multicolumn{1}{c}{理論値} & \multicolumn{1}{c}{実験値} & \multicolumn{1}{c}{相対誤差} \\ \hline
...
\end{align}
また，実験値に対する理論値の相対誤差$\epsilon$は以下のように計算できる．
\begin{align}
...
減衰振動の角周波数について，理論と実験を比較する．理論値と実験値，その相対誤差を表\ref{DOw}に示す．
...
\begin{table}[htbp]
    \begin{center}
        ...
        \begin{tabular}{rrr}
            \hline
            \multicolumn{1}{c}{理論値} & \multicolumn{1}{c}{実験値} & \multicolumn{1}{c}{相対誤差} \\ \hline
